...
type MapLayer struct {
	...
	ProviderLayer env.String `toml:"provider_layer" json:"provider_layer"`
	MinZoom       *env.Uint  `toml:"min_zoom" json:"min_zoom"`
	MaxZoom       *env.Uint  `toml:"max_zoom" json:"max_zoom"`
	DefaultTags   env.Dict   `toml:"default_tags" json:"default_tags"`
	...
	DontClean env.Bool `toml:"dont_clean" json:"dont_clean"`
}
